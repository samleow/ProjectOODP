...
public abstract class Notification
{
	...
	/**
	 * Creates a notification message with a default format.
	 * Default notification of Student successfully added into course.
	 * @param name Name of recipient.
	 * @param courseID The ID of the course.
	 * @param add Set true if Student is successfully added into course, else set false.
