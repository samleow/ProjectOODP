...
public class LoginAccount {
	/**
	 * The name of the user who owns the account. E.g. "Phua Chu Kang"
	 */
	private String name;
	/**
	 * The user name for the account E.g. "PCK123"
	 */
	private String userName;
	/**
	 * The password for the account. Will be stored with the password's hash value
	 */
	private String password;
	/**
	 * The type of account. E.g. "ADMIN"
	 */
	 ...
	 */
	public LoginAccount(String name, String userName, String password, AccountType type) {
		this.name = name;
