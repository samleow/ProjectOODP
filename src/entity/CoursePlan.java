...
/**
 * Details of a particular course index Stores the 'Time Table' of lessons
 */
public class CoursePlan implements IOData<CoursePlan> {
	...
	/**
	 * The ID of the group. E.g. "SSP2"
	 */
	private String groupID;
	/**
	 * The course index. Assumption: All index numbers are unique among course
	 * plans. E.g. "10102"
	 */
	private int index;
	/**
	 ...
	 * 
	 * @param lessons List of Lessons that stores the different lessons for this
	 *                course plan.
	 */
