...
/**
 * Contains information for all admin accounts. Inherits from parent class
 * LoginAccount.
 */
public class Admin extends LoginAccount implements IOData<Admin> {
	...
	/**
	 * Class constructor that creates an admin and inherits the name, username,
	 * password and account type from parent account.
	 * 
	 * @param name     The name of this admin.
	 * @param userName The user name of this admin.
	 * @param password The password of this admin.
	 * @param type     The account type of this user. Account Type should be admin.
	 */
	public Admin(String name, String userName, String password, AccountType type) {
	...
	public String toString() {
		return super.getName() + "|" + super.getUserName() + "|" + super.getType() + "|" + super.getPassword();
	}
	...
	/**
	 * To read each line of data from the text file and sets the admin information
	 * accordingly.
	 * 
